...
const ITEMS: Array<{
  ...
  { id: "png", group: "Diagram", label: "PNG", hint: "High-DPI raster of the studio canvas", run: (p) => exportPng(p) },
  { id: "svg", group: "Diagram", label: "SVG", hint: "Vector snapshot of the studio canvas", run: (p) => exportSvg(p) },
